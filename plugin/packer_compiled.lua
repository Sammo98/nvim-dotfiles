...
_G.packer_plugins = {
  ...
  ["leap.nvim"] = {
    loaded = true,
    path = "/Users/sam/.local/share/nvim/site/pack/packer/start/leap.nvim",
  ...
  ["vim-repeat"] = {
    loaded = true,
    path = "/Users/sam/.local/share/nvim/site/pack/packer/start/vim-repeat",
